...
public final class RampartDnsParser2_9 implements Validatable<RampartDnsBuilder, InvalidRampartRuleException> {
    private final Map<String, RampartList> symbolTable;

    public RampartDnsParser2_9(Map<String, RampartList> symbolTable) {
    ...
    static RampartDnsBuilder parse(Map<String, RampartList> symbolTable) throws InvalidRampartRuleException {
        ...
        RampartApiProtectValidator2_9.crossValidateInputAndActions(
                RampartDnsParser2_1.THIS_RULE_KEY, action, taintInputs, apiFilter);
