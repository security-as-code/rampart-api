...
public class RampartSocketParser2_3 implements Validatable<RampartSocketBuilder, InvalidRampartRuleException> {
    private final Map<String, RampartList> symbolTable;

    public RampartSocketParser2_3(Map<String, RampartList> symbolTable) {
