...
public abstract class RampartActionWithAttributeValidator extends RampartActionValidator2_0Plus {

    public RampartActionWithAttributeValidator(Map<String, RampartList> visitorSymbolTable, RampartRuleType ruleType) {
