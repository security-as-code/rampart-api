...
public final class RampartDnsParser2_3 implements Validatable<RampartDnsBuilder, InvalidRampartRuleException> {
    private final Map<String, RampartList> symbolTable;

    public RampartDnsParser2_3(Map<String, RampartList> symbolTable) {
