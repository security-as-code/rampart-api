...
public class RampartFileSystemParser2_3 implements Validatable<RampartFileSystemBuilder, InvalidRampartRuleException> {
    private final Map<String, RampartList> symbolTable;

    public RampartFileSystemParser2_3(Map<String, RampartList> symbolTable) {
