...
public class RampartLibraryParser2_3 implements Validatable<RampartLibraryBuilder, InvalidRampartRuleException> {
    private final Map<String, RampartList> symbolTable;

    public RampartLibraryParser2_3(Map<String, RampartList> symbolTable) {
