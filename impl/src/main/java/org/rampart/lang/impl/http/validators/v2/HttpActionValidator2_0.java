...
import org.rampart.lang.impl.core.validators.v2.RampartActionWithAttributeValidator;
import org.rampart.lang.impl.interpreter.RampartInterpreterUtils;

public class HttpActionValidator2_0 extends RampartActionWithAttributeValidator {
    ...
    public HttpActionValidator2_0(Map<String, RampartList> visitorSymbolTable) {
        ...
        while (it.hasNext() == RampartBoolean.TRUE) {
            ...
            if (!(value instanceof RampartNamedValue)
                ...
                throw new InvalidRampartRuleException("\"" + SET_HEADER_KEY
                        + "\" attribute must contain name value pairs with string literals as values");
            }
        }
